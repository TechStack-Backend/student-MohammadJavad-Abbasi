...
urlpatterns = [
    ...
    path('delete-account-confirm/', views.DeleteAccountConfirmation.as_view(), name='confirm_delete_account'),
    ...
    path("profile/<int:pk>/", views.ViewProfile.as_view(), name="user_profile"),
    ...
    path(
        "delete-user/<int:pk>/confirm/",
        views.DeleteAccountConfirmation.as_view(),
